      ...
      <div class="my-5 px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24 bg-white shadow rounded">
        <div class="flex flex-wrap items-center mx-auto max-w-7xl">
          <div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
            <div>
              <div class="relative w-full max-w-lg">
                ...
                <div class="animate__animated animate__backInUp relative">
                  <img
          ...
          <div class="flex flex-col items-start mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0">
            <span class="animate__animated animate__backInDown mb-8 text-4xl font-bold tracking-widest text-neutral-800 uppercase">
              I AM
            ...
            <h1 class="animate__animated animate__backInRight mb-8 text-4xl font-bold leading-none tracking-tighter text-neutral-800 md:text-7xl lg:text-5xl">
              i am a{" "}
              <span class="animate-pulse text-blue-600">
                {props.jobtitle}
              </span>
            </h1>
            <p class="animate__animated animate__fadeInBottomRight mb-8 text-xl leading-relaxed text-left text-gray-800">
              {props.desc}
            </p>
            <div class="animate__animated animate__bounceInLeft flex flex-wrap w-full mt-2 -mx-4 text-left">
