...
<div class="animate__animated animate__zoomInRight m-auto overflow-hidden rounded-lg shadow-lg h-90 w-60 md:w-80">
        ...
        <div class="w-full p-4 bg-white dark:bg-gray-800">
            ...
            <button onClick={redirectToDiscord} class="animate__animated animate__slideInUp animate__slower w-full items-center block px-10 py-3.5 text-base font-medium text-center text-blue-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    Discord
                  </button>
