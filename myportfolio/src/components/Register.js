...
export const Register = () => {
  ...
  return (
    ...
    <div className="min-w-screen min-h-screen bg-white-900 flex items-center justify-center px-5 py-5">
      <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-100px overflow-hidden" align="max-width:1000px">
              ...
              <div className="flex -mx-3">
                <div className="w-1/2 px-3 mb-5">
                  ...
                  <div className="flex">
                    ...
                    <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Name"></input>
                    </div>
                </div>
                <div className="w-1/2 px-3 mb-5">
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  ...
                  <div className="flex">
                    ...
                    <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Name@email.com">
                    </input></div>
                </div>
              </div>
              <div className="flex -mx-3">
